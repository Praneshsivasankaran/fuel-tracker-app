...
class _TripScreenState extends State<TripScreen> {
      ...
      try {
        ...
        if (_tripId != null) {
          await ApiService.sendLocation(
            _tripId!, position.latitude, position.longitude, speedKmh,
          );
        }
      } catch (e) {
    ...
    if (result != null && mounted) {
      showDialog(
        ...
        builder: (ctx) => AlertDialog(
          ...
          title: Text('Trip Complete', style: GoogleFonts.poppins(color: Colors.white)),
          content: Column(
            ...
            children: [
              ...
              Text(
                ...
                style: GoogleFonts.poppins(color: Colors.white54, fontSize: 13, fontStyle: FontStyle.italic),
              ),
            ],
          ),
          actions: [
            TextButton(
              ...
              child: Text('OK', style: GoogleFonts.poppins(color: const Color(0xFF00D2FF))),
            ),
          ],
        ),
      );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(widget.vehicle['vehicle_model'] ?? 'Trip', style: GoogleFonts.poppins()),
        backgroundColor: const Color(0xFF16213E),
      ),
      body: Padding(
          ...
          children: [
              ...
              child: Column(
                children: [
                  Text(
                    ...
                    style: GoogleFonts.poppins(fontSize: 64, fontWeight: FontWeight.bold, color: const Color(0xFF00D2FF)),
                  ),
                  Text('km/h', style: GoogleFonts.poppins(fontSize: 18, color: Colors.white54)),
                ],
              ),
            ),
            ...
            Row(
              children: [
                ...
                _buildInfoCard('Max Speed', '${_maxSpeed.toStringAsFixed(1)} km/h'),
              ],
            ),
            const SizedBox(height: 12),
            Row(
              children: [
                _buildInfoCard('Avg Speed', '${_avgSpeed.toStringAsFixed(1)} km/h'),
                const SizedBox(width: 12),
                _buildInfoCard('Duration', _isTripActive ? _formatDuration() : '00:00'),
              ],
            ),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: _isTripActive ? Colors.redAccent : const Color(0xFF00D2FF),
