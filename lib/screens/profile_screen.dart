  ...
  Future<void> _logout() async {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text('Are you sure you want to logout?', style: GoogleFonts.poppins(color: Colors.white54)),
        actions: [
          TextButton(
                      ...
                      children: [
                        CircleAvatar(
                          ...
                          child: Text(
                            ...
                            style: GoogleFonts.poppins(fontSize: 36, fontWeight: FontWeight.bold, color: const Color(0xFF00D2FF)),
                          ),
                        ),
                  ...
                  if (_analytics != null && _analytics!['total_trips'] > 0) ...[
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text('Driving Summary', style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.w600, color: Colors.white)),
                          const SizedBox(height: 16),
  ...
  Widget _buildStatRow(String label, String value) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          Text(label, style: GoogleFonts.poppins(fontSize: 14, color: Colors.white54)),
